...

                        {
                            user ?
                                <div className='flex flex-col md:flex-row items-center gap-3'>
                                    ...
                                    <button onClick={logOutHandler} className="rounded-md bg-sky-700 text-white font-semibold mb-3">Log out</button>
                                </div>
                                :
                                <Link to='/login'><button className="rounded-md bg-sky-700 text-white font-semibold mb-3">Login</button></Link>
                        }
                    </div>
                </div>
